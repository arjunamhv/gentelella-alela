...
@section('title', __('views.admin.sales_orders.create.title'))

@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            {{ Form::open(['route' => 'admin.sales.orders.store', 'method' => 'post', 'class' => 'form-horizontal form-label-left']) }}

            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="customer_id">
                    {{ __('views.admin.sales_orders.create.customer') }}
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="order_date">
                    {{ __('views.admin.sales_orders.create.order_date') }}
                    <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="product_id">
                    {{ __('views.admin.sales_orders.create.products') }}
                    <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    {{ Form::select('product_id', $products, old('product_id'), [
                        ...
                        'placeholder' => __('views.admin.sales_orders.create.select_product'),
                        'required'
                    ]) }}
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="quantity">
                    {{ __('views.admin.sales_orders.create.quantity') }}
                    <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="status">
                    {{ __('views.admin.sales_orders.create.status') }}
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    {{ Form::select('status', [
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <a class="btn btn-primary" href="{{ route('admin.sales.orders') }}">
                        {{ __('views.admin.sales_orders.create.cancel') }}
                    </a>
                    <button type="submit" class="btn btn-success">
                        {{ __('views.admin.sales_orders.create.save') }}
                    </button>
                </div>
            </div>
