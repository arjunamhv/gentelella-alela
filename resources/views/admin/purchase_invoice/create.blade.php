...
@section('title', __('views.admin.purchase_invoices.create.title'))

@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            {{ Form::open(['route' => 'admin.purchase.invoice.store', 'method' => 'post', 'class' => 'form-horizontal form-label-left']) }}

            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="purchase_order_id">
                    {{ __('views.admin.purchase_invoices.create.purchase_order') }}
                    <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    {{ Form::select('purchase_order_id', $purchaseOrders, old('purchase_order_id'), [
                        'id' => 'purchase_order_id',
                        'class' => 'form-control col-md-7 col-xs-12' . ($errors->has('purchase_order_id') ? ' parsley-error' : ''),
                        'placeholder' => __('views.admin.purchase_invoices.create.select_purchase_order'),
                        'required'
                    ]) }}
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="invoice_date">
                    {{ __('views.admin.purchase_invoices.create.invoice_date') }}
                    <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="total_amount">
                    {{ __('views.admin.purchase_invoices.create.total_amount') }}
                    <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <a class="btn btn-primary" href="{{ route('admin.purchase.invoice') }}">
                        {{ __('views.admin.purchase_invoices.create.cancel') }}
                    </a>
                    <button type="submit" class="btn btn-success">
                        {{ __('views.admin.purchase_invoices.create.save') }}
                    </button>
                </div>
            </div>
