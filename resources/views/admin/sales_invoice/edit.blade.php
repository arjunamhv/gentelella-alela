...
@section('title', __('Edit Sales Invoice'))

@section('content')
    <div class="row">
        <div class="col-md-12">
            {{ Form::open(['route' => ['admin.sales.invoices.update', $salesInvoice->id], 'method' => 'put', 'class' => 'form-horizontal form-label-left']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {{ Form::select('sales_order_id', $salesOrders, $salesInvoice->sales_order_id, ['class' => 'form-control col-md-7 col-xs-12', 'id' => 'sales_order_id', 'required']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="invoice_date" type="date" class="form-control col-md-7 col-xs-12 @if($errors->has('invoice_date')) parsley-error @endif"
                               name="invoice_date" value="{{ $salesInvoice->invoice_date->format('Y-m-d') }}" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="total_amount" type="number" step="0.01" class="form-control col-md-7 col-xs-12 @if($errors->has('total_amount')) parsley-error @endif"
                               name="total_amount" value="{{ $salesInvoice->total_amount }}" required>
